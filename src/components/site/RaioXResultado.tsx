...
// ── O RESULTADO DO RAIO-X, RENDERIZÁVEL PELO SERVIDOR ──
//
// Vivia dentro do formulário (cliente): só aparecia depois de um clique.
// Aqui fora, sem hooks, serve aos dois: ao formulário, como antes, e à
// página pública de cada município — que o Google indexa sem clique nenhum.
